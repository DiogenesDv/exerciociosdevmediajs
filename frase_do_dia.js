...
let numero_data_escolhido = data_atual.getDate();

console.log('Numero sorteado da data foi: ', numero_data_escolhido);
numero_data_escolhido--
;

let frase_do_dia_escolhido = frases_do_dia[numero_data_escolhido]; 

console.log('Frase do dia: ', frase_do_dia_escolhido);